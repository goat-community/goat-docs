...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
  <img src={require('/img/toolbox/geoanalysis/origin_destination/od_example.png').default} alt="polygon_aggregation" style={{ maxHeight: "auto", maxWidth: "auto", objectFit: "cover"}}/>
</div> 
...
<img src={require('/img/toolbox/geoanalysis/origin_destination/overview.png').default} alt="polygon_aggregation" style={{ maxHeight: "auto", maxWidth: "auto", objectFit: "cover"}}/>
...
<img src={require('/img/toolbox/geoanalysis/origin_destination/result.png').default} alt="results" style={{ maxHeight: "auto", maxWidth: "auto", objectFit: "cover"}}/>
